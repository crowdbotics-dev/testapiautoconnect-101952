...
## Project Structure
    ...
    ├── testapiautoconnect_101952  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_101952`
...
2. Clone this repo and `cd testapiautoconnect_101952`
